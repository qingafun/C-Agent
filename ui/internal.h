...
/*
 * ui/internal.h — Private shared state for the terminal UI renderer.
 *
 * This header defines the internal state and communication structures
 * used by the UI module. It should NOT be included outside of ui/.
 */
