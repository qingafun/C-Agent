...
- [x] Multi-threaded asynchronous UI engine.
- [x] Multi-turn ReAct feedback loop.
- [ ] Support for persistent filesystem sandbox.
- [ ] Integration with local vector databases for RAG.
